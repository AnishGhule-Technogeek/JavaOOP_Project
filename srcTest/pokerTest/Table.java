...
//                  int ind=0;
//                  for (Card c:allCards) {
//                      if (cardSuit.indexOf(c.getSuit()) == -1) {
//                          cardSuit.add(c.getSuit());
//                          cardFreq[ind++] = 1;
//                      } else {
//                          cardFreq[cardSuit.indexOf(c.getSuit())] += 1;
//                      }
//                  }
//                  int m1=cardFreq[0];
//                  h1= cardSuit.get(0);
...
//else
   // r=2
//                         else{
//int strt=matchCards.get(l).parseRank(matchCards.get(l).getRank())
//                       int count=1;
//                       }
//
...
///compare r and if equal use h1 and h2
